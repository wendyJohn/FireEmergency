...
public class PhotoActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		for (int i = 0; i < Bimps.bmp.size(); i++) {
			bmp.add(Bimps.bmp.get(i));
		}
		for (int i = 0; i < Bimps.drr.size(); i++) {
			drr.add(Bimps.drr.get(i));
		...
		Button photo_bt_exit = findViewById(R.id.photo_bt_exit);
		photo_bt_exit.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				finish();
			}
		});
		Button photo_bt_del =  findViewById(R.id.photo_bt_del);
		...
		Button photo_bt_enter = findViewById(R.id.photo_bt_enter);
