...
public class ARectificationAdapter extends BaseAdapter {

    private List<ARectBean.DataBean.ListBean> mList;
     ...
     * @list
     */
    public void bindData(Context mContext, List<ARectBean.DataBean.ListBean> mList) {
        this.mList = mList;
